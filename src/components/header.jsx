...
import logo from '../assets/images/delete/kkk.png'
...
const header = () => {
  ...
  return <>
    <header className='navbar-top my-0 bg-secondary'>
      <div className="container-xxl ">
        <div className="row">
          <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
            <div className="col-md-8 me-auto">
              <p className='text-black text-white'>The Trending Outfits At 100% Off</p>
            </div>
            <div className="col-md-2">
              <a className='text-white' href="tel:+">Call Us 12345698</a>
            </div>
            <div className="col-md">
              <Link className='links fs-4 text-white'><CiMail /></Link>
              <Link className='links fs-4 text-white'><BiPhoneCall /></Link>
            </div>
          </div>
    ...
    <header className='navbar-middle background sticky-top p-2 p-md-2 p-lg-2'>
      <div className="container-xxl">
