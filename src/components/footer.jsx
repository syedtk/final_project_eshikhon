    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>  Panthpath, Dhaka, 4nd floor</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="01409028264">Call Us 01409028264</a></p> </div>
          ...
          <Link to='https://twitter.com/i/flow/login' id='footer-link' target='_blank' className='gap-3'>
          <BsTwitter />
          </Link>
          <Link to={'https:https://github.com/login'} className='gap-3' id='footer-link'>
          <BsGithub />
          </Link>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Chandan Developers 2024</p>
        </div>
        <div className="col-12 col-md-6">
